...
Page({
    ...
    onLoad: function (options) {
        ...
        _this.loadData(options.projectId);
        ...
        app.data.qs.get_project_detail_with_manager({
            ...
            success: function (res) {
                ...
                _this.setData({
                    ...
                    'manager': res.data.project.manager,
                    'project_type': res.data.project.project_type,
                })
            }
        })
    },
    ...
    onShow: function () {
        var _this = this;
        if (_this.data.hidePage) {
            _this.loadData(_this.data.id);
            _this.setData({hidePage: false});
        }
    },
